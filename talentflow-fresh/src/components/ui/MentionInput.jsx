  ...
  return (
    <div className="relative">
      <textarea
        ...
        rows={rows}
        className={`block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:bg-gray-700 dark:text-white resize-none ${className}`}
      />
      
      {showSuggestions && filteredUsers.length > 0 && (
        <div
          ref={suggestionsRef}
          className="absolute z-50 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-md shadow-lg max-h-40 overflow-y-auto"
          style={{
        ...
        >
          {filteredUsers.map((user, index) => (
            <div
              ...
              className={`mention-suggestion px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer ${
