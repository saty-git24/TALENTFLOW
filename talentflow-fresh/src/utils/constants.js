...
// Proper hiring process flow - order matters!
export const HIRING_PROCESS_ORDER = [
  CANDIDATE_STAGES.APPLIED,
  CANDIDATE_STAGES.SCREEN,
  CANDIDATE_STAGES.TECH,
  CANDIDATE_STAGES.OFFER,
  CANDIDATE_STAGES.HIRED
];

// Terminal stages (cannot progress further)
...
export const STAGE_TRANSITIONS = {
  [CANDIDATE_STAGES.APPLIED]: [CANDIDATE_STAGES.SCREEN, CANDIDATE_STAGES.REJECTED],
  [CANDIDATE_STAGES.SCREEN]: [CANDIDATE_STAGES.TECH, CANDIDATE_STAGES.REJECTED],
  [CANDIDATE_STAGES.TECH]: [CANDIDATE_STAGES.OFFER, CANDIDATE_STAGES.REJECTED],
  [CANDIDATE_STAGES.OFFER]: [CANDIDATE_STAGES.HIRED, CANDIDATE_STAGES.REJECTED],
  [CANDIDATE_STAGES.HIRED]: [], // Terminal - no further transitions
  [CANDIDATE_STAGES.REJECTED]: [] // Terminal - no further transitions
};
